...
define([
        ...
        './Material',
        './SceneMode',
        '../Shaders/PolygonCollectionVS',
        '../Shaders/PolygonCollectionFS'
    ], function(
        DeveloperError,
        defaultValue,
        Color,
     ...
     * DOC_TBA
     *
     * @alias PolygonCollection
     * @constructor
     *
     * @example
     * var polygon = new PolygonCollection();
    ...
    var PolygonCollection = function() {
         ...
         * {@link PolygonCollection#update} is called, the polygon's vertex buffer
     ...
     * DOC_TBA
     *
     * @memberof PolygonCollection
     *
     * @exception {DeveloperError} This object was destroyed, i.e., destroy() was called.
     *
     * @see PolygonCollection#setPositions
     */
    PolygonCollection.prototype.getPositions = function() {
     ...
     * @exception {DeveloperError} This object was destroyed, i.e., destroy() was called.
     *
     * @see PolygonCollection#getPositions
     *
     ...
     * ], 10.0);
     */
    PolygonCollection.prototype.setPositions = function(positions, height, textureRotationAngle) {
     ...
     *  };
     */
    PolygonCollection.prototype.configureFromPolygonHierarchy  = function(hierarchy, height, textureRotationAngle) {
     ...
     * ));
     */
    PolygonCollection.prototype.configureExtent = function(extent, height) {
        this._extent = extent;
        this.height = defaultValue(height, 0.0);
        this._textureRotationAngle = undefined;
        this._positions = undefined;
...
// TODO: These are never destroyed
     ...
     * @exception {DeveloperError} This object was destroyed, i.e., destroy() was called.
     */
    PolygonCollection.prototype.update = function(context, frameState, commandList) {
     ...
     *
     * @see PolygonCollection#destroy
     */
    PolygonCollection.prototype.isDestroyed = function() {
        return false;
    };
     ...
     * @exception {DeveloperError} This object was destroyed, i.e., destroy() was called.
     *
     * @see PolygonCollection#isDestroyed
     *
     * @example
     * polygon = polygon && polygon.destroy();
     */
    PolygonCollection.prototype.destroy = function() {
